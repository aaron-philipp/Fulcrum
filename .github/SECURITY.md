...
If you discover a security vulnerability in Fulcrum, please report it responsibly:
...
Fulcrum is a static analysis tool that reads Terraform files. Security concerns include:
