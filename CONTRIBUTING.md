...
Thank you for your interest in contributing to Fulcrum! This document provides guidelines and information for contributors.
...
3. Include:
   - Fulcrum version (`pip show fulcrum`)
   - Python version
   - Operating system
...
```bash
# Clone your fork
git clone https://github.com/YOUR_USERNAME/fulcrum.git
cd fulcrum
