...
Fulcrum analyzes Terraform configurations to detect whether cloud infrastructure is synthetically generated (honeypots, deception environments, lab setups) versus organically grown production systems.
...
Fulcrum identifies these telltale signs to help security researchers, red teams, and infrastructure auditors distinguish real targets from decoys.
...
```bash
git clone https://github.com/aaron-philipp/fulcrum.git
cd fulcrum
pip install -e .
```
...
fulcrum /path/to/terraform/

# Analyze a single file
fulcrum main.tf

# Verbose output with detailed flags
fulcrum /path/to/terraform/ -v

# JSON output for automation
fulcrum /path/to/terraform/ --json

# Just the score (for scripting)
fulcrum /path/to/terraform/ -q
```
...
Fulcrum analyzes seven categories of indicators:
